                    ...
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        {
                            listMenu.map((item: IMenu) => {
                                ...
                                return (
                                    <li>
                                        <a href={item.path} className={`block py-2 pl-3 pr-4 ${isCurrentPage ? "text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:text-blue-700" : "text-white bg-blue-700 md:text-blue-700"}  marker:rounded md:bg-transparent  md:p-0`} aria-current={isCurrentPage ? "page" : "false"}>{item.title}</a>
                                    </li>
                                )
                            })
                        }
